...
// Date:              Tue Sep 18 19:32:55 2012 (by Create and Import Peripheral Wizard)
...
reg [31:0] contador/* synthesis syn_keep = 1 */;
reg [31:0] con_int/* synthesis syn_keep = 1 */;
...
begin
		...
		else if (slv_reg0[30]==1'b0)
			begin
				contador<=0;
				Interrupt_reg<=1'b0;
			end
			
		if(Interrupt_reg==1'b0)
		begin
			contador<=contador+1;
			if (contador==slv_reg1)
				begin
					Interrupt_reg<=1'b1;
					con_int<=con_int+1;
				end
  ...
  always @( slv_reg_read_sel or slv_reg0 or slv_reg1 or slv_reg2 )
    begin 
      ...
      case ( slv_reg_read_sel )
        ...
        3'b001 : slv_ip2bus_data <= con_int;
