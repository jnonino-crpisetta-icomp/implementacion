...
/* Declarations */
#define maximo_comidas_cada_filosofo 1000
...
int main()
{
    ...
    xil_printf("INICIO DE EJECUCION PETRI SIN YIELD - %d Comidas para cada filosofo", maximo_comidas_cada_filosofo);
