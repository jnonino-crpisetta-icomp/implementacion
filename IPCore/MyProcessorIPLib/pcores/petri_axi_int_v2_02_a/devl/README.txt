...
Peripheral Summary:
  ...
  logical library name                       : petri_axi_int_v2_02_a
  top name                                   : petri_axi_int
  version                                    : 2.02.a
  type                                       : AXI4LITE slave
...
- ISE project file(s)
  ...
  devl/projnav/petri_axi_int.xise
...
- XST synthesis file(s)
  ...
  devl/synthesis/petri_axi_int_xst.prj
...
-user needs to add these to repositories path in SDK (Xilinx Tools-->Repositories)
  ...
  data/petri_axi_int_v2_1_0.mdd

    This is the Microprocessor Driver Definition file.

  data/petri_axi_int_v2_1_0.tcl
...
axi_lite_ipif_v1_01_a
	D:\ProyectoIntegrador\trunk\Implementacion\SingleCoreAXI_INT\C:\Xilinx\14.2\ISE_DS\EDK\hw\XilinxProcessorIPLib\pcores\axi_lite_ipif_v1_01_a\doc\axi_lite_ipif_ds765.pdf
