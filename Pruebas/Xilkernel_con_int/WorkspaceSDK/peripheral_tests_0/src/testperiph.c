...
int main() 
{
   ...
   static XIntc intc;
   static XGpio Push_Buttons_5Bits_Gpio;
   static XTmrCtr axi_timer_0_Timer;
   static XGpio DIP_Switches_8Bits_Gpio;
   ...
   }
   {
      ...
      Status = GpioIntrExample(&intc, &Push_Buttons_5Bits_Gpio, \
   ...
   }
   {
      ...
      Status = GpioIntrExample(&intc, &DIP_Switches_8Bits_Gpio, \
                               XPAR_DIP_SWITCHES_8BITS_DEVICE_ID, \
                               XPAR_MICROBLAZE_0_INTC_DIP_SWITCHES_8BITS_IP2INTC_IRPT_INTR, \
                               GPIO_CHANNEL1, &DataRead);
