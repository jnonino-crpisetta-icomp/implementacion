...
//
// Revision: 
//		Revision 01 - Julián Nonino - Creacion de los paramteros y entradas de datos para operar
//
//		Revision 02 - Julián Nonino - Creacion de los elementos internos para la operacion - Julián Nonino
//
//		Revision 03 - Julián Nonino - Creacion de un modulo que realice la suma entre el marcado inicial y cada columna
//										   	de la matriz de incidencia. A su vez, arma un vector que define las tranciones
//										   	posibles segun haya o no valores negativos.
//
// 	Revision 04 - Julián Nonino - Creacion del proceso que determina si la transicion produce un nuevo estado
...
//
// 	Revision 06 - Julián Nonino - Creacion de los modulos de actualizacion de las colas de entrada y salida
...
//
//		Revision 08 - Julián Nonino - Implementacion del vector que determina si una transicion esta sensibilidaza
//										   	según los arcos inhibidores.
//
//		Revision 09 - Julián Nonino - Implementacion de automatizacion de disparos, se creo un registro pra marcar las
//										   	transiciones que se determinaron automaticas.
//
//		Revision 10 - Julián Nonino - Implementacion de un bit que informa si la red sigue activa o no
//
...
//
//		Revision 12 - Julián Nonino - Eliminacion del registro plazas ilimitadas. De ahora en adelante, si una plaza debería
...
//
// 	Revision 14 - Julián Nonino - Agregado de la salida de disparos y de una señal de ack para que desde el exterior
//				  		  Renzo Pisetta - se verifico si se realizo la escritura deseada.
//
// 	Revision 15 - Julián Nonino - Se agrego un vector de transiciones sensibilizadas, de esta manera, el vector de 
//												disparos posibles queda para cuando la transicion esta sensibilizada y ademas, cumple
//												con las restricciones temporales.
//
//		Revision 16 - Julián Nonino - Creacion de los vectores EFT, LFT y cuenta de tiempo para la implementacion de Redes
//												de Petri con Tiempo
//
//		Revision 17 - Julián Nonino - Implementación de la actualización de la marcas de tiempo
//												Implementación del vector de habilitacion segun marcas temporales
//
// 	Revision 18 - Julián Nonino - Modificación del algoritmo de actualizacion de marcas de tiempo.
//												Ahora se actualiza en el bloque que actualiza el marcado.
//
//		Revision 19 - Julián Nonino - Modifique la carga de vectores de tiempo EFT y LFT para que permita
//												que se cargue un valor de 64 bits.
//
//		Revision 20 - Julián Nonino - Modificacion colas de entrada y salida.
//
//		Revision 21 - Julián Nonino - Acomode el orden de las direcciones para acceder a los datos.
//
//		Revision 22 - Julián Nonino - Realice una modificacion en la actualización del marcado que resolvio el problema
...
//
//		Revision 26 - Julián Nonino - Modificada la generacion de la señal red_activa
//
//		Revision 27 - Julián Nonino - Se crea este nuevo IP core que al comienzo es identico al time_petri_axi
//												por esta razon se mantienen todas las revisiones anteriores. Este IP core se 
//												modificara para implementar la resolucion de Redes de Petri Temporizadas.
//
//		Revision 28 - Julián Nonino - Modificacion de los registros relacionados con el tiempo.
//												Se elimino el vector LFT y se cambio el nombre del vector EFT a vector_duracion.
//												Se modifico la logica de carga de datos.
//
//		Revision 29 - Julián Nonino - Modificacion de la logica de ejecucion de la red para trbajar con Redes
...
// --USER parameters added here 
	parameter cant_plazas								= 10;	//Cantidad de plazas de la red de Petri modelada
	parameter cant_transiciones						= 7;	//Cantidad de transiciones de la red de Petri modelada
	parameter bits_cant_transiciones					= 3;//Numero de Bits necesarios para representar el numero cant_transiciones
	parameter tamano_de_elementos						= 16; 	//Tamano de los elementos de los arreglos marcado y resultados, medido en bits
	parameter tamano_de_elementos_incidencia		= 3; 	//Tamano de los elementos de las matrices de incidencia, medido en bits
...
// ------------------------------------------------------
// Direcciones para realizar el acceso a los registros de este procesador para efectuar la carga de datos,
// la solicitud de disparos y el retiro de estos ultimos.
// 
//		Direcciones para escribir en Petri
//			Xuint32 *m_marcado_addr    						= (Xuint32 *)(XPAR_PETRI_AXI_INT_0_BASEADDR);
//			Xuint32 *m_incidencia_positiva_addr				= (Xuint32 *)(XPAR_PETRI_AXI_INT_0_BASEADDR + 0x4);
//			Xuint32 *m_incidencia_negativa_addr				= (Xuint32 *)(XPAR_PETRI_AXI_INT_0_BASEADDR + 0x8);
//			Xuint32 *m_inhibicion_addr 						= (Xuint32 *)(XPAR_PETRI_AXI_INT_0_BASEADDR + 0xC);
//			Xuint32 *p_cotas_addr								= (Xuint32 *)(XPAR_PETRI_AXI_INT_0_BASEADDR + 0x10);
//			Xuint32 *t_automatica_addr 						= (Xuint32 *)(XPAR_PETRI_AXI_INT_0_BASEADDR + 0x14);
//			Xuint32 *load_vector_duracion_addr				= (Xuint32 *)(XPAR_PETRI_AXI_INT_0_BASEADDR + 0x18);
//			Xuint32 *load_vector_incrementos_tiempo_addr = (Xuint32 *)(XPAR_PETRI_AXI_INT_0_BASEADDR + 0x1C);
//			Xuint32 *t_intr_addr									= (Xuint32 *)(XPAR_PETRI_AXI_INT_0_BASEADDR + 0x20);
//			Xuint32 *prioridades									= (Xuint32 *)(XPAR_PETRI_AXI_INT_0_BASEADDR + 0x24);
//			Xuint32 *new_disparo_addr  						= (Xuint32 *)(XPAR_PETRI_AXI_INT_0_BASEADDR + 0x28);
//			Xuint32 *sacar_disparo_addr						= (Xuint32 *)(XPAR_PETRI_AXI_INT_0_BASEADDR + 0x2C);
...
/***********************REGISTROS NECESARIOS PARA LA EJECUCION DE LA RED DE PETRI***********************/
	...
	// Datos
		...
		//Matriz de incidencia positiva
			reg [tamano_de_elementos_incidencia-1:0] matriz_incidencia_positiva [cant_plazas-1:0] [cant_transiciones-1:0]/* synthesis syn_keep = 1 */;	
		//Matriz de incidencia negativa
			reg [tamano_de_elementos_incidencia-1:0] matriz_incidencia_negativa [cant_plazas-1:0] [cant_transiciones-1:0]/* synthesis syn_keep = 1 */;	
		//Arcos inhibidores
		...
		//Redes de Petri con Tiempo
			reg [tamano_de_elementos_tiempo-1:0] vector_duracion [cant_transiciones-1:0]/* synthesis syn_keep = 1 */;
			...
			for (columnas=0 ; columnas<cant_transiciones ; columnas=columnas+1) //Recorro columnas
				begin
					for (filas=0 ; filas<cant_plazas ; filas=filas+1) // Recorro filas
						begin
							resultado[filas][columnas] = marcado[filas] + matriz_incidencia_positiva[filas][columnas] - matriz_incidencia_negativa[filas][columnas]; //Ecuacion
				...
				begin
					for(index2=0 ; index2<cant_transiciones ; index2=index2+1)
						begin
							...
							if ((transiciones_automaticas[index2]|disparos_en_espera[index2]) & t_sensibilizadas[index2] == 1'b1)
								begin
									...
									//Decremento el contador de la cola de disparos en espera correspondiente
										...
										if (disparos_en_espera[index2] == 1'b1) disparo_entrada_decrementa[index2] <= 1'b1;	
										else disparo_entrada_decrementa[index2] <= 1'b0;								
									//Vuelvo a habilitar la transicion
										mask_semi_ejecucion[index2] <= 1'b0;
								end
							else if (colas_salida_llenas[index2]==1'b0 & mask_semi_ejecucion[index2] == 1'b0 & vector_tiempo_sensibilizacion[index2] >= vector_duracion[index2]) // Veo si el disparo en espera esta en las transiciones sensibilizadas
								begin
								...
								begin
									...
									//Actualizo marcas temporales
										if (mask_semi_ejecucion[index2] == 1'b1) vector_tiempo_sensibilizacion[index2] <= {tamano_de_elementos_tiempo{1'b0}};
					...
					for (filas_reset=0 ; filas_reset<cant_plazas ; filas_reset=filas_reset+1)
						...
						cotas_plazas [filas_reset] 							<= {tamano_de_elementos{1'b0}};
							for (columnas_reset=0 ; columnas_reset<cant_transiciones ; columnas_reset=columnas_reset+1)
								begin
									matriz_incidencia_positiva[filas_reset][columnas_reset] 	<= {tamano_de_elementos{1'b0}};
									matriz_incidencia_negativa[filas_reset][columnas_reset] 	<= {tamano_de_elementos{1'b0}};
									matriz_inhibicion [filas_reset][columnas_reset] <= 1'b0;
									vector_duracion [columnas_reset]<={tamano_de_elementos_tiempo{1'b0}};//Vector tiempo minimo
									vector_incremento_de_tiempo [columnas_reset]<=1'b1;
					...
					case (slv_reg_write_sel)
						m_marcado: //Carga del marcado inicial
							begin
								carga<=1'b1;
								intr_reset<=0;
								marcado_inicial [Bus2IP_Data[tamano_bus-1:tamano_bus-bits_bus_plazas]]<=Bus2IP_Data[bits_bus_elementos-1:0];
								disparo_entrada_incrementa <= {cant_transiciones{1'b0}};
								disparo_salida_decrementa <= {cant_transiciones{1'b0}};								
								ack_escritura_reg = 1'b1;
							end //FIN del caso m_marcado
						m_incidencia_positiva: //Carga de la matriz de incidencia positiva
							begin
								carga<=1'b1;
								intr_reset<=0;
								matriz_incidencia_positiva [Bus2IP_Data[tamano_bus-1:tamano_bus-bits_bus_plazas]] [Bus2IP_Data[tamano_bus-bits_bus_plazas-1:tamano_bus-bits_bus_plazas-bits_bus_transiciones]] <= Bus2IP_Data[bits_bus_elementos-1:0];
								disparo_entrada_incrementa <= {cant_transiciones{1'b0}};
								disparo_salida_decrementa <= {cant_transiciones{1'b0}};
								ack_escritura_reg = 1'b1;	
							end //FIN del caso m_incidencia
						m_incidencia_negativa: //Carga de la matriz de incidencia negativa
							begin
								carga<=1'b1;
								intr_reset<=0;
								matriz_incidencia_negativa [Bus2IP_Data[tamano_bus-1:tamano_bus-bits_bus_plazas]] [Bus2IP_Data[tamano_bus-bits_bus_plazas-1:tamano_bus-bits_bus_plazas-bits_bus_transiciones]] <= Bus2IP_Data[bits_bus_elementos-1:0];
								disparo_entrada_incrementa <= {cant_transiciones{1'b0}};
								disparo_salida_decrementa <= {cant_transiciones{1'b0}};
								ack_escritura_reg = 1'b1;	
							end //FIN del caso m_incidencia
						...
						p_cotas: //Carga del vector de cotas
							begin
								carga<=1'b1;
								intr_reset<=0;
								cotas_plazas [Bus2IP_Data[tamano_bus-1:tamano_bus-bits_bus_plazas]] <= Bus2IP_Data[bits_bus_elementos-1:0];
								disparo_entrada_incrementa <={cant_transiciones{1'b0}};
								disparo_salida_decrementa <= {cant_transiciones{1'b0}};
								ack_escritura_reg = 1'b1;
						...
						load_vector_duracion:
							begin
								carga<=1'b1;
								intr_reset<=0;
								if (Bus2IP_Data[tamano_bus-1:tamano_bus-bits_bus_plazas]==8'b00000000) //Parte menos significativa de duracion
									begin
										vector_duracion [Bus2IP_Data[tamano_bus-bits_bus_plazas-1:tamano_bus-bits_bus_plazas-bits_bus_transiciones]][15:0]<=Bus2IP_Data[bits_bus_elementos-1:0];
									end
								else if (Bus2IP_Data[tamano_bus-1:tamano_bus-bits_bus_plazas]==8'b00000001)
									begin
										vector_duracion [Bus2IP_Data[tamano_bus-bits_bus_plazas-1:tamano_bus-bits_bus_plazas-bits_bus_transiciones]][31:16]<=Bus2IP_Data[bits_bus_elementos-1:0];
									end
								else if (Bus2IP_Data[tamano_bus-1:tamano_bus-bits_bus_plazas]==8'b00000010)//Parte mas significativa de duracion
									begin
										vector_duracion [Bus2IP_Data[tamano_bus-bits_bus_plazas-1:tamano_bus-bits_bus_plazas-bits_bus_transiciones]][47:32]<=Bus2IP_Data[bits_bus_elementos-1:0];
									end
//								else if (Bus2IP_Data[tamano_bus-1:tamano_bus-bits_bus_plazas]==8'b00000011)//Parte mas significativa de duracion
//									begin
//										vector_duracion [Bus2IP_Data[tamano_bus-bits_bus_plazas-1:tamano_bus-bits_bus_plazas-bits_bus_transiciones]][63:48]<=Bus2IP_Data[bits_bus_elementos-1:0];
//									end
//								else if (Bus2IP_Data[tamano_bus-1:tamano_bus-bits_bus_plazas]==8'b00000100)//Parte mas significativa de duracion
//									begin
//										vector_duracion [Bus2IP_Data[tamano_bus-bits_bus_plazas-1:tamano_bus-bits_bus_plazas-bits_bus_transiciones]][79:64]<=Bus2IP_Data[bits_bus_elementos-1:0];
//									end
//								else if (Bus2IP_Data[tamano_bus-1:tamano_bus-bits_bus_plazas]==8'b00000101)//Parte mas significativa de duracion
//									begin
//										vector_duracion [Bus2IP_Data[tamano_bus-bits_bus_plazas-1:tamano_bus-bits_bus_plazas-bits_bus_transiciones]][95:80]<=Bus2IP_Data[bits_bus_elementos-1:0];
//									end
//								else if (Bus2IP_Data[tamano_bus-1:tamano_bus-bits_bus_plazas]==8'b00000110)//Parte mas significativa de duracion
//									begin
//										vector_duracion [Bus2IP_Data[tamano_bus-bits_bus_plazas-1:tamano_bus-bits_bus_plazas-bits_bus_transiciones]][111:81]<=Bus2IP_Data[bits_bus_elementos-1:0];
//									end
//								else if (Bus2IP_Data[tamano_bus-1:tamano_bus-bits_bus_plazas]==8'b00000111)//Parte mas significativa de duracion
//									begin
//										vector_duracion [Bus2IP_Data[tamano_bus-bits_bus_plazas-1:tamano_bus-bits_bus_plazas-bits_bus_transiciones]][127:112]<=Bus2IP_Data[bits_bus_elementos-1:0];
//									end
								disparo_entrada_incrementa <= {cant_transiciones{1'b0}};
								disparo_salida_decrementa <= {cant_transiciones{1'b0}};
								ack_escritura_reg = 1'b1;
						...
						load_vector_incrementos_tiempo:
							begin
								carga<=1'b1;
								intr_reset<=0;
								vector_incremento_de_tiempo [Bus2IP_Data[tamano_bus-bits_bus_plazas-1:tamano_bus-bits_bus_plazas-bits_bus_transiciones]]<=Bus2IP_Data[bits_bus_elementos-1:0];//generar vector sacar de aca
								disparo_entrada_incrementa <= {cant_transiciones{1'b0}};
								disparo_salida_decrementa <= {cant_transiciones{1'b0}};
								ack_escritura_reg = 1'b1;
							end
						...
						v_prioridades:
							begin
								carga<=1'b1;
								intr_reset<=0;
								vector_prioridades[Bus2IP_Data[tamano_bus-bits_bus_plazas-1:tamano_bus-bits_bus_plazas-bits_bus_transiciones]]<=Bus2IP_Data[bits_bus_elementos-1:0];
								disparo_entrada_incrementa <={cant_transiciones{1'b0}};
								disparo_salida_decrementa <= {cant_transiciones{1'b0}};
								ack_escritura_reg = 1'b1;
							end
