...
int main()
{
    ...
    xil_printf("TRES HILOS, Valor Maximo = %d \r\n\n",valor_maximo);
	...
	int vector_LFT [cantidad_transiciones][cantidad_palabras_vector_tiempo];
    	...
    	int transiciones_intr [cantidad_transiciones];
    		...
    		transiciones_intr[5] = 0x00050001;
    		transiciones_intr[6] = 0x00060001;
    		transiciones_intr[7] = 0x00070001;
    		transiciones_intr[8] = 0x00080001;
    		transiciones_intr[9] = 0x00090001;
