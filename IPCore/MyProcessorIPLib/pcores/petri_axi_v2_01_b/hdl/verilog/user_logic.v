...
//					  	  Renzo Pisetta - se verifique si se realizo la escritura deseada o no.
//
...
// --USER parameters added here 
	parameter cant_plazas								= 12;	//Cantidad de plazas de la red de Petri modelada
	parameter cant_transiciones						= 12;	//Cantidad de transiciones de la red de Petri modelada
    ...
    begin 
      case ( slv_reg_read_sel )
        ...
        //Usadas para leer
				...
				32'b00000000000000100000000000000000 : slv_ip2bus_data <= marcado[0];//38
				32'b00000000000000010000000000000000 : slv_ip2bus_data <= marcado[1];//3C
				32'b00000000000000001000000000000000 : slv_ip2bus_data <= marcado[2];//40
				32'b00000000000000000100000000000000 : slv_ip2bus_data <= marcado[3];//44			
				32'b00000000000000000010000000000000 : slv_ip2bus_data <= marcado[4];//48
				32'b00000000000000000001000000000000 : slv_ip2bus_data <= marcado[5];//4C
				32'b00000000000000000000100000000000 : slv_ip2bus_data <= marcado[6];//50
				32'b00000000000000000000010000000000 : slv_ip2bus_data <= marcado[7];//54
				32'b00000000000000000000001000000000 : slv_ip2bus_data <= marcado[8];//58
				32'b00000000000000000000000100000000 : slv_ip2bus_data <= marcado[9];//5C
				//32'b00000000000000000000000010000000 : slv_ip2bus_data <= marcado[10];//60
				//32'b00000000000000000000000001000000 : slv_ip2bus_data <= marcado[11];//64
				//32'b00000000000000000000000000100000 : slv_ip2bus_data <= marcado[12];//68
				//32'b00000000000000000000000000010000 : slv_ip2bus_data <= marcado[13];//6C
				//32'b00000000000000000000000000001000 : slv_ip2bus_data <= marcado[14];//70
				//32'b00000000000000000000000000000100 : slv_ip2bus_data <= marcado[15];//74
