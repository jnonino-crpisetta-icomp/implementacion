/*****************************************************************************
* Filename:          D:\ProyectoIntegrador\trunk\Implementacion\IPCore\MyProcessorIPLib/drivers/timer_v1_00_a/src/timer.h
* Version:           1.00.a
...
#define TIMER_SLV_REG3_OFFSET (TIMER_USER_SLV_SPACE_OFFSET + 0x0000000C)
#define TIMER_SLV_REG4_OFFSET (TIMER_USER_SLV_SPACE_OFFSET + 0x00000010)

/**
 * Software Reset Space Register Offsets
 * -- RST : software reset register
 */
#define TIMER_SOFT_RST_SPACE_OFFSET (0x00000100)
#define TIMER_RST_REG_OFFSET (TIMER_SOFT_RST_SPACE_OFFSET + 0x00000000)
...
#define TIMER_mWriteSlaveReg3(BaseAddress, RegOffset, Value) \
 	Xil_Out32((BaseAddress) + (TIMER_SLV_REG3_OFFSET) + (RegOffset), (Xuint32)(Value))
#define TIMER_mWriteSlaveReg4(BaseAddress, RegOffset, Value) \
 	Xil_Out32((BaseAddress) + (TIMER_SLV_REG4_OFFSET) + (RegOffset), (Xuint32)(Value))
...
#define TIMER_mReadSlaveReg3(BaseAddress, RegOffset) \
 	Xil_In32((BaseAddress) + (TIMER_SLV_REG3_OFFSET) + (RegOffset))
#define TIMER_mReadSlaveReg4(BaseAddress, RegOffset) \
 	Xil_In32((BaseAddress) + (TIMER_SLV_REG4_OFFSET) + (RegOffset))

/**
 *
 * Reset TIMER via software.
 *
 * @param   BaseAddress is the base address of the TIMER device.
 *
 * @return  None.
 ...
 * @note
 * C-style signature:
 * 	void TIMER_mReset(Xuint32 BaseAddress)
 *
 */
#define TIMER_mReset(BaseAddress) \
 	Xil_Out32((BaseAddress)+(TIMER_RST_REG_OFFSET), SOFT_RESET)
