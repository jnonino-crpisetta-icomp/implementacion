...
//Direcciones relacionadas con el AXI timer
	Xuint32 *TCSR0 	= (Xuint32 *)(XPAR_AXI_TIMER_0_BASEADDR + 0x00);
	Xuint32 *TLR0 	= (Xuint32 *)(XPAR_AXI_TIMER_0_BASEADDR + 0x04);
	Xuint32 *TCR0 	= (Xuint32 *)(XPAR_AXI_TIMER_0_BASEADDR + 0x08);
...
int main()
{
    ...
    //Carga de datos
		int matriz_incidencia [cantidad_plazas][cantidad_transiciones];
			matriz_incidencia[0][0] = 0x0000FFFF;
		   	...
		   	matriz_incidencia[1][3] = 0x01030001;
	    	...
	    	matriz_incidencia[1][9] = 0x01090000;
		   	...
		   	matriz_incidencia[2][2] = 0x0202FFFF;
	    	...
	    	matriz_incidencia[3][0] = 0x0300FFFF;
	    	matriz_incidencia[3][1] = 0x03010001;
	    	...
	    	matriz_incidencia[4][0] = 0x04000001;
	    	matriz_incidencia[4][1] = 0x0401FFFF;
	    	...
	    	matriz_incidencia[5][2] = 0x0502FFFF;
	    	matriz_incidencia[5][3] = 0x05030001;
		...
		int marcado_inicial [cantidad_plazas];
		   	marcado_inicial[0] = 0x00000001;//mutex
		   	marcado_inicial[1] = 0x01000005;//vacios
		   	marcado_inicial[2] = 0x02000000;//llenos
		   	marcado_inicial[3] = 0x03000001;//P3 - Productores esperando
		   	marcado_inicial[4] = 0x04000000;//P4 - Produciendo
		   	marcado_inicial[5] = 0x05000001;//P5 - Consumidores esperando
		   	marcado_inicial[6] = 0x06000000;//P6 - COnsumiendo
		   	marcado_inicial[7] = 0x07000000;
		   	marcado_inicial[8] = 0x08000000;
		   	marcado_inicial[9] = 0x09000000;

		int cotas_plazas [cantidad_plazas];
	    	cotas_plazas[0] = 0x00000001;//mutex
	    	cotas_plazas[1] = 0x01000005;//vacios
	    	cotas_plazas[2] = 0x02000005;//llenos
	    	cotas_plazas[3] = 0x03000001;//P3
	    	cotas_plazas[4] = 0x04000001;//P4
	    	cotas_plazas[5] = 0x05000001;//P5
	    	cotas_plazas[6] = 0x06000001;//P6
	    	cotas_plazas[7] = 0x0700FFFF;
	    	cotas_plazas[8] = 0x0800FFFF;
	    	cotas_plazas[9] = 0x0900FFFF;
    ...
    //Creacion y lanzamiendo de los hilos
...
/*	xil_printf ("Soy el hilo %s MARCADO AL INICIO\r\n",nombre);
	mostrar_marcado();
	xil_printf ("\r\n\n");
*/
	while (cantidad_de_acciones < 10)
...
/*			xil_printf ("Soy el hilo %s MARCADO\r\n",nombre);
			mostrar_marcado();
			xil_printf ("\r\n\n");
*/
		//Pedir T1
