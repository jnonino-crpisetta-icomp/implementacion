...
int cuentas=0;
//sem_t semaforos[cantidad_transiciones];
...
int main()
{
	...
	int matriz_incidencia [cantidad_plazas][cantidad_transiciones];
		matriz_incidencia[0][0] = 0x0000FFFF;
	   	...
	   	matriz_incidencia[0][9] = 0x00090001;
    	...
    	matriz_incidencia[6][3] = 0x06030001;
    	matriz_incidencia[6][4] = 0x0604FFFF;
    	...
    	matriz_incidencia[7][4] = 0x0704FFFF;
    	matriz_incidencia[7][5] = 0x07050001;
    	...
    	matriz_incidencia[8][4] = 0x08040001;
    	matriz_incidencia[8][5] = 0x0805FFFF;
    	...
    	matriz_incidencia[9][5] = 0x09050001;
    	matriz_incidencia[9][6] = 0x0906FFFF;
		...
		matriz_incidencia[10][6] = 0x0A06FFFF;
		matriz_incidencia[10][7] = 0x0A070001;
		...
		matriz_incidencia[11][6] = 0x0B060001;
		matriz_incidencia[11][7] = 0x0B07FFFF;
		...
		matriz_incidencia[12][8] = 0x0C08FFFF;
		matriz_incidencia[12][9] = 0x0C090001;
		...
		matriz_incidencia[13][8] = 0x0D080001;
		matriz_incidencia[13][9] = 0x0D09FFFF;
		...
		matriz_incidencia[14][7] = 0x0E070001;
		matriz_incidencia[14][8] = 0x0E08FFFF;
	...
	int matriz_inhibicion [cantidad_plazas][cantidad_transiciones];
		...
		matriz_inhibicion[11][4] = 0x0B040000;
		...
		matriz_inhibicion[12][4] = 0x0C040000;
		...
		matriz_inhibicion[13][4] = 0x0D040000;
		...
		matriz_inhibicion[14][4] = 0x0E040000;
	...
	int marcado_inicial [cantidad_plazas];
		...
		marcado_inicial[10] = 0x0A000001;
		marcado_inicial[11] = 0x0B000000;
		marcado_inicial[12] = 0x0C000001;
	...
	int cotas_plazas [cantidad_plazas];
		...
		cotas_plazas[11] = 0x0B000001;
		cotas_plazas[12] = 0x0C000001;
		cotas_plazas[13] = 0x0D000001;
		cotas_plazas[14] = 0x0E000001;
	...
	int vector_LFT [cantidad_transiciones][cantidad_palabras_vector_tiempo];
    	...
    	int transiciones_intr [cantidad_transiciones];
    		transiciones_intr[0] = 0x00000000;
    		transiciones_intr[1] = 0x00010000;
    		transiciones_intr[2] = 0x00020000;
...
/*	//Semaforos para interrupcion	
		...
		status = status + sem_init(&semaforos[5], 1, 0);
		status = status + sem_init(&semaforos[6], 1, 0);
		status = status + sem_init(&semaforos[7], 1, 0);
		status = status + sem_init(&semaforos[8], 1, 0);
		status = status + sem_init(&semaforos[9], 1, 0);
		if(status == 0)
	...
	while(cuentas<valor_maximo)
	{
		...
		//Sacar T4 de los disparos ejecutados
			*(sacar_disparo_addr) = disparo_t_cuatro;
			cuentas=cuentas+1;
//			xil_printf("%d",numero_de_hilo_tres);
	...
	while(cuentas<valor_maximo)
	{
		...
		//Sacar T6 de los disparos ejecutados
			*(sacar_disparo_addr) = disparo_t_seis;
			...
			cuentas=cuentas+1;
//			xil_printf("%d",numero_de_hilo_cuatro);
	...
	while(cuentas<valor_maximo)
	{
		...
		//Sacar T8 de los disparos ejecutados
			*(sacar_disparo_addr) = disparo_t_ocho;
			...
			cuentas=cuentas+1;
//			xil_printf("%d",numero_de_hilo_cinco);
