...
Peripheral Summary:
  ...
  XPS project / EDK repository               : D:\ProyectoIntegrador\trunk\Implementacion\IPCore\MyProcessorIPLib
  logical library name                       : petri_plb_v2_00_b
  top name                                   : petri_plb
  version                                    : 2.00.b
  type                                       : PLB (v4.6) slave
...
- XST synthesis file(s)
  ...
  devl/synthesis/petri_plb_xst.prj
...
- BFM simulation project file(s)
  ...
  devl/bfmsim/scripts/run.tcl

    This is the ISim Tcl command file to load models and start simulation.

  devl/bfmsim/scripts/wave.tcl

    This is the ISim wave window signal list file.
...
- BFM simulation IP testbench file(s)
  ...
  devl/bfmsim/pcores/petri_plb_tb_2_00_b/hdl/vhdl/petri_plb_tb.vhd

    This is the peripheral IP testbench to be used in BFM or hardware simualtion.

  devl/bfmsim/pcores/petri_plb_tb_2_00_b/data/petri_plb_tb_v2_1_0.mpd

    This is Microprocessor Peripheral Description file for the peripheral IP testbench.

  devl/bfmsim/pcores/petri_plb_tb_2_00_b/data/petri_plb_tb_v2_1_0.pao
...
-user needs to add these to repositories path in SDK (Xilinx Tools-->Repositories)
  ...
  data/petri_plb_v2_1_0.mdd

    This is the Microprocessor Driver Definition file.

  data/petri_plb_v2_1_0.tcl
...
plbv46_slave_single_v1_01_a
	D:\ProyectoIntegrador\trunk\Implementacion\SingleCorePLB\C:\Xilinx\14.2\ISE_DS\EDK\hw\XilinxProcessorIPLib\pcores\plbv46_slave_single_v1_01_a\doc\plbv46_slave_single.pdf

interrupt_control_v2_01_a
	D:\ProyectoIntegrador\trunk\Implementacion\SingleCorePLB\C:\Xilinx\14.2\ISE_DS\EDK\hw\XilinxProcessorIPLib\pcores\interrupt_control_v2_01_a\doc\interrupt_control.pdf
