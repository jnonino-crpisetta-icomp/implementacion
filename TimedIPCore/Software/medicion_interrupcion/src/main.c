...
/* Declarations */
#define cantidad_interrupciones 10000

//#define marcado_inicial_p_cero 0x00000001	//Para 1
//#define marcado_inicial_p_cero 0x0000000A	//Para 10
//#define marcado_inicial_p_cero 0x00000064	//Para 100
//#define marcado_inicial_p_cero 0x000003E8	//Para 1000
#define marcado_inicial_p_cero 0x00002710	//Para 10000
...
int main()
{
    ...
    xil_printf("INICIO DE EJECUCION PETRI");
    ...
    /* Cargar los datos de la Red de Petri */
		int matriz_incidencia_positiva [cantidad_plazas][cantidad_transiciones];
			...
			matriz_incidencia_positiva[1][0] = 0x01000001;
			...
			matriz_incidencia_positiva[8][3] = 0x08030000;
		...
		int cotas_plazas [cantidad_plazas];
			cotas_plazas[0] = 0x0000FFFF;
			cotas_plazas[1] = 0x0100FFFF;
...
void* master_thread(void *arg)
{
    ...
    //Iniciar cuenta de tiempo
 	...
 	while (i < cantidad_interrupciones)
 	{
   		//Pedir T0
