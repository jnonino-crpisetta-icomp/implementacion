...
// --USER parameters added here 
	...
	parameter tamano_de_elementos_tiempo 			= 32;	//Tamano de los elementos de los arreglos de cuenta de tiempo, medido en bits
...
/****************************CARGA DE DATOS**********************/
	...
	//Definicion de los posibles address para escritura
		...
		localparam error									= 32'b00000000000100000000000000000000;//2C
					...
					case (slv_reg_write_sel)
						...
						m_incidencia: //Carga de la matriz de incidencia
							begin
								carga<=1'b1;
								intr_reset<=0;
								matriz_incidencia [Bus2IP_Data[tamano_bus-1:tamano_bus-bits_bus_plazas]] [Bus2IP_Data[tamano_bus-bits_bus_plazas-1:tamano_bus-bits_bus_plazas-bits_bus_transiciones]] <= Bus2IP_Data[bits_bus_elementos-1:0];
								disparo_entrada_incrementa <= {cant_transiciones{1'b0}};
								disparo_salida_decrementa <= {cant_transiciones{1'b0}};
								ack_escritura_reg = 1'b1;	
						...
						p_cotas: //Carga del vector de cotas
							begin
								carga<=1'b1;
								intr_reset<=0;
								cotas_plazas [Bus2IP_Data[tamano_bus-1:tamano_bus-bits_bus_plazas]] <=Bus2IP_Data[bits_bus_elementos-2:0];
								disparo_entrada_incrementa <={cant_transiciones{1'b0}};
								disparo_salida_decrementa <= {cant_transiciones{1'b0}};
								ack_escritura_reg = 1'b1;
						...
						load_vector_EFT:
							begin
								...
								if (Bus2IP_Data[tamano_bus-1:tamano_bus-bits_bus_plazas]==8'b00000000) //Parte menos significativa de duracion
									begin
										vector_EFT [Bus2IP_Data[tamano_bus-bits_bus_plazas-1:tamano_bus-bits_bus_plazas-bits_bus_transiciones]][15:0]<=Bus2IP_Data[bits_bus_elementos-1:0];
									end
								else if (Bus2IP_Data[tamano_bus-1:tamano_bus-bits_bus_plazas]==8'b00000001)
									begin
										vector_EFT [Bus2IP_Data[tamano_bus-bits_bus_plazas-1:tamano_bus-bits_bus_plazas-bits_bus_transiciones]][31:16]<=Bus2IP_Data[bits_bus_elementos-1:0];
									end
...
//									end
						...
						load_vector_LFT:
							begin
								...
								if (Bus2IP_Data[tamano_bus-1:tamano_bus-bits_bus_plazas]==8'b00000000) //Parte menos significativa de duracion
									begin
										vector_LFT [Bus2IP_Data[tamano_bus-bits_bus_plazas-1:tamano_bus-bits_bus_plazas-bits_bus_transiciones]][15:0]<=Bus2IP_Data[bits_bus_elementos-1:0];
									end
								else if (Bus2IP_Data[tamano_bus-1:tamano_bus-bits_bus_plazas]==8'b00000001)
									begin
										vector_LFT [Bus2IP_Data[tamano_bus-bits_bus_plazas-1:tamano_bus-bits_bus_plazas-bits_bus_transiciones]][31:16]<=Bus2IP_Data[bits_bus_elementos-1:0];
									end
//								else if (Bus2IP_Data[tamano_bus-1:tamano_bus-bits_bus_plazas]==8'b00000010)//Parte mas significativa de duracion
//									begin
//										vector_LFT [Bus2IP_Data[tamano_bus-bits_bus_plazas-1:tamano_bus-bits_bus_plazas-bits_bus_transiciones]][47:32]<=Bus2IP_Data[bits_bus_elementos-1:0];
//									end
//								else if (Bus2IP_Data[tamano_bus-1:tamano_bus-bits_bus_plazas]==8'b00000011)//Parte mas significativa de duracion
//									begin
//										vector_LFT [Bus2IP_Data[tamano_bus-bits_bus_plazas-1:tamano_bus-bits_bus_plazas-bits_bus_transiciones]][63:48]<=Bus2IP_Data[bits_bus_elementos-1:0];
//									end
//								else if (Bus2IP_Data[tamano_bus-1:tamano_bus-bits_bus_plazas]==8'b00000100)//Parte mas significativa de duracion
//									begin
//										vector_LFT [Bus2IP_Data[tamano_bus-bits_bus_plazas-1:tamano_bus-bits_bus_plazas-bits_bus_transiciones]][79:64]<=Bus2IP_Data[bits_bus_elementos-1:0];
//									end
//								else if (Bus2IP_Data[tamano_bus-1:tamano_bus-bits_bus_plazas]==8'b00000101)//Parte mas significativa de duracion
//									begin
//										vector_LFT [Bus2IP_Data[tamano_bus-bits_bus_plazas-1:tamano_bus-bits_bus_plazas-bits_bus_transiciones]][95:80]<=Bus2IP_Data[bits_bus_elementos-1:0];
//									end
//								else if (Bus2IP_Data[tamano_bus-1:tamano_bus-bits_bus_plazas]==8'b00000110)//Parte mas significativa de duracion
//									begin
//										vector_LFT [Bus2IP_Data[tamano_bus-bits_bus_plazas-1:tamano_bus-bits_bus_plazas-bits_bus_transiciones]][111:81]<=Bus2IP_Data[bits_bus_elementos-1:0];
//									end
//								else if (Bus2IP_Data[tamano_bus-1:tamano_bus-bits_bus_plazas]==8'b00000111)//Parte mas significativa de duracion
//									begin
//										vector_LFT [Bus2IP_Data[tamano_bus-bits_bus_plazas-1:tamano_bus-bits_bus_plazas-bits_bus_transiciones]][127:112]<=Bus2IP_Data[bits_bus_elementos-1:0];
//									end
								disparo_entrada_incrementa <= {cant_transiciones{1'b0}};
								disparo_salida_decrementa <= {cant_transiciones{1'b0}};
								ack_escritura_reg = 1'b1;
