...
#define una_hora 5350 //Considerando un segundo como un pulso de clock a 75 MHz (el valor esta en milisegundos)
...
//       	if (status != 0)	{ 	xil_printf ("ERROR LANZANDO HILO ARMADOR");	}
	...
	//pthread_join(hilo_cortador,(void*)&mesas_cortadas);
	//pthread_join(hilo_lijador,(void*)&mesas_lijadas);
	//pthread_join(hilo_pintor,(void*)&mesas_pintadas);
	//pthread_join(hilo_secador,(void*)&mesas_secadas);
