...
int main()
{
    ...
    //Lanzamiendo de los hilos escritores
		...
		pthread_join(hilo_cortador, NULL);
    	pthread_join(hilo_lijador, NULL);
    	pthread_join(hilo_pintor, NULL);
     	pthread_join(hilo_secador, NULL);
     	pthread_join(hilo_armador, NULL);
